...
const DriverAssociateRegister = () => {
    ...
    const validation = useFormik({
        ...
        initialValues: {
            ...
            pays: driver.pays || '',
            ville: driver.ville || '',
            principal_driver_email: driver.principla_email || ''
        },
        validationSchema: Yup.object({
            ...
            principal_driver_email: Yup.string().required("Please Enter your principal email")
        }),
        onSubmit: (values) => {
        ...
        <div>
            <Container>
                <Form onSubmit={(e) => {
                    ...
                    <FormGroup>
                        <Label for="principal_driver_email">
                            Email Chauffeur Principal
                        </Label>
                        <Input
                            id="principal_driver_email"
                            name="principal_driver_email"
                            placeholder="Entrez l'email du chauffeur principal"
                            type="email"
                            value={validation.values.principal_driver_email || ""}
                            className="form-control pe-5"
                            onChange={validation.handleChange}
                            onBlur={validation.handleBlur}
                            invalid={
                                validation.touched.principal_driver_email && validation.errors.principal_driver_email ? true : false
                            }
                        />
                        {validation.touched.principal_driver_email && validation.errors.principal_driver_email ? (
                                <FormFeedback type="invalid">{validation.errors.principal_driver_email}</FormFeedback>
                            ) : null}
